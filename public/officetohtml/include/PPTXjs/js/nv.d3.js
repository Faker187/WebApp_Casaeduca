    ...
    */
        ...
        function chart(selection) {
            ...
            selection.each(function(data) {
                ...
                var outliers = boxplots.selectAll('.nv-boxplot-outlier').data(function(d) {
                    if (d.values.hasOwnProperty('outliers') && d.values.outliers !== null) { return d.values.outliers; } else { return []; }
                });
    ...
    nv.models.bulletChart = function() {
        ...
        chart._options = Object.create({}, {
            ...
            // deprecated options
            tooltips: {
                get: function() { return tooltip.enabled(); },
                set: function(_) {
            ...
            tooltipContent: {
                get: function() { return tooltip.contentGenerator(); },
                set: function(_) {
                    // deprecated after 1.7.1
    ...
    nv.models.parallelCoordinates = function() {
        ...
        chart._options = Object.create({}, {
            ...
            // deprecated options
            dimensions: {
                get: function() { return dimensionNames; },
                set: function(_) {
