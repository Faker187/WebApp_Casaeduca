      ...
      <div class="sidebar-fixed position-fixed">
        ...
        <div class="list-group list-group-flush border">
          ...
          <a href="#" class="list-group-item list-group-item-action waves-effect active">
            <i class="fas fa-user mr-3"></i>Alumnos</a>
          <a href="#" class="list-group-item list-group-item-action waves-effect ">
            <i class="fas fa-user mr-3"></i>Profesores</a>
          <a href="#" class="list-group-item list-group-item-action waves-effect">
            <i class="fas fa-table mr-3"></i>Cursos</a>
          <a href="#" class="list-group-item list-group-item-action waves-effect">
            <i class="fas fa-table mr-3"></i>Unidades</a>
          <a href="#" class="list-group-item list-group-item-action waves-effect">
            <i class="fas fa-table mr-3"></i>Clases</a>
          <a href="#" class="list-group-item list-group-item-action waves-effect">
            <i class="fas fa-money-bill-alt mr-3"></i>Pagos</a>
        </div>
