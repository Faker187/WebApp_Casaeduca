            ...
            <div class="text-white text-left py-5 px-4 my-5">
              <div class="cursodatacard">
                <h2 class="card-title h1-responsive pt-3 mb-2 font-bold color-ce0 text-center">
                    <img class="card-img" src="{{ asset('img/009-certification.svg') }}" style="width: 70px;margin-bottom: 1rem;" alt="regla corazon">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card w-100 border-0">
                <div class="card-body">
                    <h3 class="card-title pr-2 color-ce0 text-center py-2 animated wow fadeInUp"><img class="card-img" src="{{ asset('img/LIBROS.png') }}" style="width: 100px;" alt="libros plan academico">Nuestro Proyecto Educativo</h3>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card w-100 border-0">
                <div class="card-body">
                    <h3 class="card-title pr-2 color-ce0 text-center py-2 animated wow fadeInUp"><img class="card-img mt-0 mb-5" src="{{ asset('img/011-light-bulb.svg') }}" style="width: 60px;" alt="">¿Qué es importante tener presente?</h3>
                    <p class="card-text text-justify"><img class="card-img mt-0 mb-5" src="{{ asset('img/FLECHAS1.png') }}" alt="primero blog"></p>                    
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card w-100 border-0">
                <div class="card-body border-right">
                    <h3 class="card-title pr-2 color-ce0 text-center py-2 animated wow fadeInUp"><img class="card-img mt-0 mb-5 pr-2" src="{{ asset('img/050-school-bell.png') }}" style="width: 60px;" alt="">Supcripción Mensual</h3>
        ...
        <div class="col-md-6">
            <div class="card w-100 border-0">
                <div class="card-body">
                    <h3 class="card-title pr-2 color-ce0 text-center py-2 animated wow fadeInUp"><img class="card-img mt-0 mb-5 pr-2" src="{{ asset('img/profesora.svg') }}" style="width: 60px;" alt="">Soporte Educacional</h3>
...
<div class="container mb-5">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card w-100 border-0">
                <div class="card-body">
                    <h3 class="card-title pr-2 color-ce0 text-center py-2 animated wow fadeInUp"><img class="card-img mt-0 mb-5 pr-2" src="{{ asset('img/008-blackboard.svg') }}" style="width: 60px;" alt="">Descripción</h3>
                    <div class="row">
                        <div class="col-md-6">
