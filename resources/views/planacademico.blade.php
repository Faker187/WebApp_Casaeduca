...
<div class="row mt-5">
    <div class="col-md-12">
        <h1 class="display-4 text-left text-white">
            <img class="card-img" src="{{ asset('public/img/LIBROS.png') }}" style="width: 140px;" alt="libros plan academico">
            Plan Académico
        </h1>
    </div>
</div>
<div class="row mt-5">
    ...
    <div class="col-md-4">
        <img class="card-img rounded-circle hoverable my-5" src="{{ asset('public/img/blog1.jpg') }}" alt="primero blog">
    </div>
    <div class="col-md-12">
        <h1 class="h1-responsive text-center text-white">
            <img class="card-img" src="{{ asset('public/img/AMPOYETA.png') }}" style="width: 80px;margin-bottom: 2.2rem;" alt="libros plan academico">
            Que es importante tener presente
        </h1>
        <img class="card-img mt-0 mb-5" src="{{ asset('public/img/FLECHAS.png') }}" alt="primero blog">
    </div>
    <div class="col-md-12">
        <h1 class="h1-responsive text-left text-white">
            <ins>Supcripción Mensual</ins>
            <img class="card-img" src="{{ asset('public/img/PIZARRA.png') }}" style="width: 70px;margin-bottom: 1rem;" alt="libros plan academico">
        </h1>
    ...
    <div class="col-md-12">
        <h1 class="h1-responsive text-left text-white">
            <ins>Descripción</ins>
            <img class="card-img" src="{{ asset('public/img/MANO_B.png') }}" style="width: 100px;margin-bottom: 1rem;" alt="libros plan academico">
        </h1>
    ...
    <div class="col-md-12">
        <h1 class="h1-responsive text-left text-white">
            ...
            <img class="card-img" src="{{ asset('public/img/COPA.png') }}" style="width: 55px;margin-bottom: 1rem;" alt="libros plan academico">
        </h1>
